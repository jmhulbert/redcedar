...
```{r}
filtered.symptoms.and.factors <- filtered.symptoms[c(45,46,50:59,68:332,337:341,355:503)]
```
...
```{r}
less.fifty.three <- filtered.symptoms.and.factors.and.nearzerovar[-c(240,241,279,299,322,326)]
```
