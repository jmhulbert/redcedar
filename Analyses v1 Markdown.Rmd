...
```{r}
WAsoils <- read.csv("./data/WA GPS with Soils.csv")
names(WAsoils)
...
```{r}
combined2 <- left_join(combined,WAsoils,by="id")
```
...
```{r}
wa.filtered.symptoms <- filtered.symptoms  %>% filter(RASTERVALU>=0)
```
...
```{r}
ggplot(wa.filtered.symptoms,aes(field.tree.canopy.symptoms,muaggatt_brockdepmin,fill=field.tree.canopy.symptoms))+geom_boxplot(show.legend=FALSE)+coord_flip()+theme_bw() +labs(x="Symptoms")
```
...
```{r}
ggplot(wa.filtered.symptoms,aes(muaggatt_drclassdcd,field.tree.canopy.symptoms,color=field.tree.canopy.symptoms))+geom_count(show.legend=FALSE)+coord_flip()+theme_bw() +labs(x="Symptoms")
```
```{r}
ggplot(wa.filtered.symptoms,aes(field.tree.canopy.symptoms,fill=field.tree.canopy.symptoms))+geom_bar(show.legend=FALSE)+coord_flip()+theme_bw() +labs(x="Symptoms")+facet_wrap(~muaggatt_drclassdcd)
```
###### drclasswettest
```{r}
ggplot(wa.filtered.symptoms,aes(muaggatt_drclasswettest,field.tree.canopy.symptoms,color=field.tree.canopy.symptoms))+geom_count(show.legend=FALSE)+coord_flip()+theme_bw() +labs(x="Symptoms")
```

```{r}
ggplot(wa.filtered.symptoms,aes(field.tree.canopy.symptoms,fill=field.tree.canopy.symptoms))+geom_bar(show.legend=FALSE)+coord_flip()+theme_bw() +labs(x="Symptoms")+facet_wrap(~muaggatt_drclasswettest)
```
###### hydgrpdcd
```{r}
ggplot(wa.filtered.symptoms,aes(muaggatt_hydgrpdcd,field.tree.canopy.symptoms,color=field.tree.canopy.symptoms))+geom_count(show.legend=FALSE)+coord_flip()+theme_bw() +labs(x="Symptoms")
```

```{r}
ggplot(wa.filtered.symptoms,aes(field.tree.canopy.symptoms,fill=field.tree.canopy.symptoms))+geom_bar(show.legend=FALSE)+coord_flip()+theme_bw() +labs(x="Symptoms")+facet_wrap(~muaggatt_hydgrpdcd)
```

###### slopegradwta
```{r}
ggplot(wa.filtered.symptoms,aes(field.tree.canopy.symptoms,muaggatt_slopegradwta,fill=field.tree.canopy.symptoms))+geom_boxplot(show.legend=FALSE)+coord_flip()+theme_bw() +labs(x="Symptoms")
```

###### niccdcdpct
```{r}
ggplot(wa.filtered.symptoms,aes(field.tree.canopy.symptoms,muaggatt_niccdcdpct,fill=field.tree.canopy.symptoms))+geom_boxplot(show.legend=FALSE)+coord_flip()+theme_bw() +labs(x="Symptoms")
```
