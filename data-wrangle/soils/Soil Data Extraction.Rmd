      ...
      + followed directions here https://support.esri.com/en/technical-article/000022163
        ...
        + Output Point Features - extract_GPS_Washington
          + Check 'Interpolate values at the point locations' (note, I am not sure if this is the best choice)
            ...
            + However, unchecking this option did not speed up the extraction process. 
        ...
        + Environments
          + Uncheck 'Maintain fully qualified field names' as it will rename all the fields muggatt_1 through x to reflect which table it came from originally. 
        
> Note the column headers were not extracted correctly following this protocol! Shoot
I am wondering if it is because we added muggatt and component data to the same raster, then extracted from that raster
