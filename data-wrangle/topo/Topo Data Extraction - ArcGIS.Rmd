...
* Process
  ...
  + Repeat for the following measurements (Descriptions Below)
    ...
    + LF - Landform
  + Merge Rasters (search for tool - merge multidimensional rasters)
    + click the down arrow for 'merge many'
    + select rasters you want to merge (warning - after selecting, it takes a long time to load, before you can even click run)
